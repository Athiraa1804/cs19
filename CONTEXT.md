...
Allow admins to manage answer quality.

Recommended:

* list of open queries
* replies needing verification
* verify answer action
* convert to FAQ action
...
* Admin role may be simulated initially if backend auth is not ready
