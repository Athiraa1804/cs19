...
export const mockQueries: Query[] = [
  ...
  },
  {
    ...
    createdBy: 'intern-rahul',
    latestReplyPreview: 'Yes, stipend continues during extension. Fill the extension form on the portal.',
  ...
  },
  {
    ...
    createdBy: 'intern-rahul',
    latestReplyPreview: 'The certificate is role-based. Skills can be added to your experience letter on request.',
